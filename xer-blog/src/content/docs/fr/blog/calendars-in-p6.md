...
Comprendre les calendriers est essentiel pour la qualité du calendrier, la planification des ressources, l'examen du chemin critique et la discipline de mise à jour.
...
flowchart TD
    ...
    E --> G["Examiner les dates, le flottant et l'histogramme des ressources"]
    F --> G
```
...
Le résultat peut prêter à confusion. Les dates peuvent changer de manière inattendue. Les activités peuvent sembler se terminer un jour plus tard. Float peut changer sans raison logique évidente. Les histogrammes de ressources peuvent ne pas correspondre au plan d'exécution. Le chemin critique peut évoluer en raison du comportement du calendrier plutôt que d’une séquence réelle.
...
Commencez par identifier la norme du calendrier du projet. Définissez la semaine de travail normale, les heures de début et de fin de la journée de travail, les jours fériés, les périodes d'arrêt et les fenêtres de travail spéciales.
...
Ensuite, passez en revue les activités pour lesquelles les dates semblent étranges. Ajoutez des colonnes pour le calendrier d'activité, le type d'activité, le début, la fin, le début anticipé, la fin anticipée, le flottement total, les ressources et les calendriers de ressources si disponibles.
...
Après avoir apporté les corrections, recalculez le calendrier et examinez les dates concernées, le flottant, le chemin critique et l'histogramme des ressources.
...
Les calendriers dans P6 définissent quand le travail peut avoir lieu. Ils affectent les dates d'activité, le flottant, le chemin critique, le chargement des ressources, les décalages et le comportement de mise à jour.
