...
La métrique « Activités commençant à la date de données sans logique de conduite » est un test rigoureux de la qualité du calendrier.
...
Si l’activité n’a pas de logique motrice, le démarrage est plus faible. L'activité peut se trouver à la date de données parce qu'elle n'a pas de prédécesseur, parce que la logique est incomplète, parce qu'une contrainte la force ou parce que la mise à jour n'a pas été entièrement statutée.
...
Trop peu de logique crée des départs et des arrivées ouverts, un flottement peu fiable et des résultats de chemin critique faibles. Trop de logique peut rendre le réseau difficile à examiner et cacher le véritable moteur d’une activité.
...
Lorsque les activités commencent à la date de données sans logique de conduite, le calendrier révèle une faiblesse dans cette histoire. L'activité peut être affichée comme prête, mais le réseau n'explique pas pourquoi.
