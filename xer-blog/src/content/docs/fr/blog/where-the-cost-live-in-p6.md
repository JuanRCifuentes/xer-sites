...
- La valeur gagnée ou le progrès est basé sur les ressources.
...
Le coût réel est important pour les rapports d’avancement et la valeur gagnée. Il montre ce qui a été dépensé ou enregistré jusqu'à présent.
...
P6 peut prendre en charge les champs de valeur gagnée tels que la valeur planifiée, la valeur gagnée, le coût réel, l'écart de coût et l'écart de calendrier, en fonction de la configuration du projet.
