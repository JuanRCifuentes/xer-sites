...
Soyez prudent avec la logique LOE. Si une LOE est mal liée, elle peut sembler modifier les dates ou fausser le flottant. Les activités LOE doivent être examinées lors des contrôles de qualité du calendrier, en particulier lorsqu'elles apparaissent sur le chemin critique ou ont des relations FS ou SF inhabituelles.
