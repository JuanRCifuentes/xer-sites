...
seo_title: "Matrice de criticité - Primavera P6"
meta_description: "Comprendre Matrice de criticité dans Primavera P6 avec une approche pratique de la planification, du contrôle projet et de la qualité du planning."
description: "Comprendre Matrice de criticité dans Primavera P6 avec une approche pratique de la planification, du contrôle projet et de la qualité du planning."
author_name: "Juan D Vargas"
author_description: "Project control manager, 30+ years of experience in Project Control"
author_link: "[https://www.linkedin.com/in/juan-d-vargas-v/](https://www.linkedin.com/in/juan-d-vargas-v/)"
keywords:
  - "Matrice de criticité"
  - "Primavera P6 Matrice de criticité"
  - "qualité du planning"
  - "Primavera P6"
  - "contrôle projet"
  - "logique CPM"
  - "revue de planning"
slug: "fr/blog/criticality-matrix-in-primavera-p6"
language: "fr"
content_type: "blog"
draft: false
version: "1.0"
...
primary_search_intent: "Comprendre Matrice de criticité dans Primavera P6 avec une approche pratique de la planification, du contrôle projet et de la qualité du planning."
related_metrics:
...
related_blogs:
  ...
  - "08b_blogs_fr/05_ACTIVITY TYPES IN P6/05_ACTIVITY TYPES IN P6.md"
...
La première dimension est la sensibilité ou la probabilité du calendrier. Cela peut être mesuré par la fréquence à laquelle une activité devient critique au cours de la simulation Monte Carlo, ou par sa proximité avec la critique sur la base de la marge total ou des seuils quasi critiques.
...
Les mesures de risque importantes incluent l’indice de criticité, la marge total, l’indice de sensibilité du calendrier et la durée ou la valeur d’impact.
...
Total marge indique à quel point une activité est sur le point d'affecter la fin du projet dans le calendrier déterministe. Une marge proche de zéro est un signe d’avertissement.
...
L’activité B n’est peut-être pas aussi urgente que l’activité A, mais elle mérite néanmoins qu’on s’y intéresse. Son marge est limité et sa probabilité de devenir critique est significative.

L'activité C a plus de marge et une moindre criticité. Il ne faut pas l’ignorer, mais cela ne nécessite pas le même niveau de concentration en matière de gestion.
...
Ajoutez ensuite des champs d'analyse des risques facultatifs, tels que l'indice de criticité et l'indice de sensibilité du calendrier. Si les données de simulation ne sont pas disponibles, utilisez des seuils pratiques basés sur la marge et la durée. Par exemple, une criticité élevée peut signifier une marge totale inférieur ou égal à 0 jour, ou un IC supérieur à 70 %. Une criticité moyenne peut signifier une marge quasi critique ou un IC compris entre 40 % et 70 %.
