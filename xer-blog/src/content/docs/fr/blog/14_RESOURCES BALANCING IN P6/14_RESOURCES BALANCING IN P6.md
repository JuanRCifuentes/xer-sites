...
L'équilibrage des ressources permet de relier le planning CPM à la capacité réelle du terrain et du bureau.
...
Le nivellement des ressources est un calcul de planning.
...
- Le nivellement a-t-il utilisé la marge disponible ou retardé la fin du projet ?
...
Soyez également prudent lorsque vous utilisez le nivellement des ressources selon un calendrier contractuel ou de référence. La mise à niveau peut déplacer les dates et affecter la marge. L'équipe doit comprendre si le calendrier nivelé est le plan officiel, un scénario de simulation ou une vue de planification interne.
