...
In Primavera P6, la criticità si riferisce solitamente alla possibilità che un'attività possa influenzare la data di fine del progetto se viene ritardata. Tradizionalmente, P6 identifica le attività critiche utilizzando le impostazioni del float totale o del percorso più lungo.

La definizione deterministica comune è semplice:

- Le attività critiche sono attività con flottante pari a zero o negativo.
...
La prima dimensione è la sensibilità o probabilità della pianificazione. Ciò può essere misurato dalla frequenza con cui un'attività diventa critica durante la simulazione Monte Carlo o da quanto è vicina alla critica in base al flottante totale o alle soglie quasi critiche.

La seconda dimensione è l’impatto. Ciò significa la gravità del ritardo se l'attività slitta. L'impatto può essere basato sulla durata dell'attività, sull'effetto di ritardo sulla conclusione del progetto, sull'indice di sensibilità, sull'esposizione ai costi, sull'impatto delle tappe contrattuali o sul giudizio del management.
...
Questo tipo di visualizzazione è utile perché separa le attività che compaiono semplicemente nel filtro critico dalle attività che meritano un'attenzione da parte del management attivo.
...
Importanti parametri di rischio includono l'indice di criticità, il flottante totale, l'indice di sensibilità della pianificazione e la durata o il valore di impatto.
...
Total Float mostra quanto un'attività è vicina a influenzare la fine del progetto nella pianificazione deterministica. Il float vicino allo zero è un segnale di avvertimento.
...
L’attività B potrebbe non essere urgente come l’attività A, ma merita comunque attenzione. Ha un flottante limitato e una significativa probabilità di diventare critico.

L'attività C ha più float e minore criticità. Non dovrebbe essere ignorato, ma non richiede lo stesso livello di attenzione da parte del management.
...
- Comunicare più chiaramente il rischio di pianificazione al management.
...
Inizia esportando i dati delle attività da P6. Include ID attività, Nome attività, WBS, Float totale, Durata rimanente, Inizio, Fine, Calendario, vincoli e indicatori di percorso critico o più lungo.

Quindi aggiungi campi facoltativi di analisi del rischio, come Indice di criticità e Indice di sensibilità della pianificazione. Se i dati della simulazione non sono disponibili, utilizzare soglie pratiche basate sul float e sulla durata. Ad esempio, una criticità elevata potrebbe significare un float totale inferiore o uguale a 0 giorni o un CI superiore al 70%. La criticità media potrebbe significare un float quasi critico o un CI compreso tra il 40% e il 70%.
...
Una matrice di criticità è uno strumento di supporto alle decisioni, non una risposta automatica. Le soglie dovrebbero essere riviste dal team di controllo del progetto e adattate al tipo di progetto, alla sensibilità del contratto e alla scadenza della pianificazione.

Ricorda inoltre che la matrice dipende dalla qualità della pianificazione. Se il programma P6 presenta una logica mancante, durate non realistiche, vincoli rigidi, calendari inadeguati o aggiornamenti di stato deboli, la matrice erediterà tali punti deboli.

Il miglior utilizzo della matrice è combinare l'output analitico con il giudizio di pianificazione professionale.

## Conclusione

Una matrice di criticità classifica le attività del progetto in base alla probabilità che diventino critiche e all’impatto che avrebbero se ritardate. Utilizza dati P6 come flottante totale, durata, vincoli e logica e può essere rafforzato con risultati Monte Carlo come l'indice di criticità e l'indice di sensibilità della pianificazione.

Per i project manager e i revisori del PMO, la matrice trasforma il rischio di pianificazione in una conversazione gestionale più chiara. Aiuta il team a concentrarsi sulle attività che contano di più, non solo sulle attività che appaiono nel filtro critico di oggi.
