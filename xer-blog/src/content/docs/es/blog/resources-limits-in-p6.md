...
Esto es poderoso, pero debe manejarse con cuidado. Resource leveling puede cambiar fechas forecast. Si los limites, calendarios, prioridades y logica no estan bien mantenidos, el resultado nivelado puede verse matematico, pero no practico.
...
Revise los perfiles de recursos durante cada actualizacion del cronograma. Si el forecast cambia, la demanda de recursos tambien cambia. Los limites deben revisarse junto con logica, calendarios, duraciones remanentes y progreso.
