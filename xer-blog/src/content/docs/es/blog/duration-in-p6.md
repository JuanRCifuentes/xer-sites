...
Remaining Duration es la cantidad de tiempo laborable que todavia se necesita para completar la actividad desde la Data Date actual.
...
Remaining Duration es uno de los campos de actualizacion mas importantes en P6. Si esta mal, el forecast estara mal.

Use Remaining Duration para responder: cuanto tiempo laborable todavia se requiere?

## Actual Duration

Actual Duration representa la cantidad de tiempo ya consumido en la actividad segun el avance real. Esta ligada a Actual Start, Actual Finish, Data Date, calendarios y metodo de actualizacion.

Actual Duration debe apoyar la historia de estado. Si una actividad ya inicio, la actual duration debe tener sentido respecto al Actual Start y la Data Date. Si la actividad esta completada, Actual Duration debe alinearse con el periodo real de trabajo.
...
Esto es util porque muestra si se espera que una actividad tome mas o menos tiempo que lo planificado originalmente. Si Original Duration era 10 dias pero At Completion Duration ahora es 15 dias, la actividad esta forecasted para durar mas de lo previsto.
