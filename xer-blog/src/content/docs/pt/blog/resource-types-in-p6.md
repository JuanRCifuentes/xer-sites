...
Um erro comum é usar recursos de mão de obra para tudo. Isso pode facilitar o carregamento de custos no início, mas reduz a clareza quando as quantidades de equipamentos ou materiais são importantes.
...
A escolha do tipo de recurso certo facilita a análise do cronograma. Ele melhora os histogramas de mão de obra, o planejamento de equipamentos, o rastreamento de materiais, o carregamento de custos, o valor agregado e os relatórios de previsão.
