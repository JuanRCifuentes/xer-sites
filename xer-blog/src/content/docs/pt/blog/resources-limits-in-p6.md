...
Por exemplo, dois trabalhos pesados ​​podem estar ambos logicamente prontos. Mas se ambos precisarem do mesmo guindaste, o limite de recursos pode mostrar que o plano excede a capacidade disponível.
...
Os limites de recursos devem, portanto, fazer parte de um processo de agendamento controlado e não um botão pressionado no final de uma atualização.
