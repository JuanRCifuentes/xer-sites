...
A duração real deve apoiar a história do status. Se uma atividade tiver sido iniciada, a duração real deverá fazer sentido em relação ao Início Real e à Data dos Dados. Se a atividade for concluída, a Duração Real deverá estar alinhada com o período de trabalho real.
