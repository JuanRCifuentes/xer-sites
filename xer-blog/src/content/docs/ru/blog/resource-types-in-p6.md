...
Роли следует пересматривать по мере развития проекта. Если расписание требует детального контроля, роли, возможно, придется заменить реальными ресурсами.

## Календари ресурсов

Ресурсы могут иметь календари. Это важно, поскольку доступность ресурсов может отличаться от доступности активности.

Например, для строительной деятельности может использоваться 6-дневный календарь работ, но назначенный специалист поставщика может быть доступен только с понедельника по пятницу. Если действие зависит от ресурса или используется выравнивание ресурсов, календарь ресурсов может повлиять на расписание.
...
Третья ошибка — назначение ресурсов без сохранения фактических единиц. Расписание с загрузкой ресурсов полезно только в том случае, если обновления хода выполнения поддерживают актуальность данных о ресурсах.
...
Определите стратегию использования ресурсов перед загрузкой расписания.
...
Выбор правильного типа ресурса упрощает анализ расписания. Он улучшает гистограммы трудозатрат, планирование оборудования, отслеживание материалов, загрузку затрат, освоенный объем и прогнозную отчетность.
