...
Логика — это математическое представление последовательности и зависимостей внутри расписания проекта. В нем объясняется, что должно произойти перед чем, какие действия могут выполняться одновременно и как команда проекта намерена перейти от первого действия к окончательному завершению.
...
Метрика «Действия, начинающиеся в дату данных без логики управления» является надежным тестом качества расписания.
...
Если действие имеет действительную логику предшественника, расписание может объяснить начало. Возможно, территорию освободили. Возможно, поставка материала была завершена. Возможно, предыдущая деятельность завершилась и позволила приступить к работе следующей команде.
...
Этот баланс имеет решающее значение для пересмотра расписания PMO. Плотная сеть не является автоматически сильной сетью. Легкая сеть не является автоматически чистой сетью. Правильная сеть объясняет план выполнения без помех.
...
Если этот драйвер запуска отсутствует, действие может переместиться в искусственное положение в расписании. Во время обновлений она может отображаться в поле «Дата данных». Это создает ложное чувство готовности.
...
Отношения «Начало-Начало» и «Окончание-Окончание» полезны, но их следует использовать осторожно. Во многих проверках расписания их лучше всего понимать как «половинные» отношения, поскольку они сами по себе не полностью помещают операцию в законченный логический путь.
...
В P6 полезные столбцы обзора включают идентификатор действия, имя действия, WBS, начало, окончание, статус действия, общий резерв, предшественники, преемники, тип отношений, задержку, ограничения, календарь и индикаторы движущих отношений, если они доступны.
