...
## لماذا يهم نوع المورد؟

يؤثر نوع المورد على كيفية تعامل P6 مع الوحدات والأسعار والتكاليف والتقويمات والتقارير.

يتصرف مورد العمل بشكل مختلف عن المورد المادي. لا ينبغي التعامل مع الرافعة بنفس طريقة التعامل مع حجم الخرسانة. إن دور المهندس العام ليس هو نفسه دور مورد مهندس مسمى. إذا تم خلط أنواع الموارد بشكل غير صحيح، فقد تصبح الرسوم البيانية وتقارير التكلفة ومراجعات الإنتاجية ومخرجات القيمة المكتسبة مضللة.

يجيب نوع المورد على سؤال عملي: ما نوع الشيء الذي تم تخصيصه للنشاط؟
...
يمكن أن تدعم موارد المواد منحنيات المواد وتتبع الكمية وتحميل التكلفة. وهي مفيدة بشكل خاص عندما يكون الجدول متصلاً بالكميات المثبتة أو القيمة المكتسبة بناءً على الكميات.
...
على سبيل المثال، قد يستخدم نشاط البناء تقويم نشاط مدته 6 أيام، ولكن قد يكون متخصص البائع المعين متاحًا فقط من الاثنين إلى الجمعة. إذا كان النشاط يعتمد على المورد أو تم استخدام تسوية المورد، فيمكن أن يؤثر تقويم المورد على الجدول.
...
عندما تبدو تواريخ الموارد غريبة، تحقق من تقويم النشاط وتقويم المورد.
...
يعد هذا مفيدًا للجداول المحملة بالتكلفة وتقارير القيمة المكتسبة وتنبؤات الموارد وتحليل التدفق النقدي. ولكنها تعمل بشكل جيد فقط عند الحفاظ على الوحدات والأسعار والتقويمات وتحديثات التقدم.

## اختيار نوع المورد المناسب

استخدم العمالة عندما يكون المورد شخصًا أو طاقمًا أو جهدًا بشريًا.

استخدم Nonlabor عندما يكون المورد عبارة عن معدات أو أصل قابل لإعادة الاستخدام ويكون وقته مهمًا.

استخدم المادة عندما يكون المورد كمية قابلة للاستهلاك.
...
أحد الأخطاء الشائعة هو استخدام موارد العمل في كل شيء. وهذا يمكن أن يجعل تحميل التكلفة أسهل في البداية، ولكنه يقلل من الوضوح عندما تكون المعدات أو كميات المواد مهمة.
...
الخطأ الثالث هو تخصيص الموارد دون الحفاظ على الوحدات الفعلية. يكون الجدول المحمل بالموارد مفيدًا فقط إذا كانت تحديثات التقدم تحافظ على تحديث بيانات المورد.
...
يؤدي اختيار نوع المورد المناسب إلى تسهيل تحليل الجدول الزمني. فهو يعمل على تحسين الرسوم البيانية للعمالة، وتخطيط المعدات، وتتبع المواد، وتحميل التكاليف، والقيمة المكتسبة، وإعداد التقارير المتوقعة.
