...
flowchart TD
    ...
    B -- "نعم، بدء الحدث" --> C["ابدأ الحدث الرئيسي"]
...
يتم استخدام الأنشطة المعتمدة على المورد عندما تتأثر المدة وسلوك الجدولة بالموارد المخصصة للنشاط. في هذه الحالة، يمكن لـ P6 استخدام تقويمات الموارد وتوافر الموارد لحساب كيفية جدولة النشاط.
...
يجب استخدام الأنشطة المعتمدة على المورد بحذر. إذا لم يكن المشروع محملاً بالموارد بشكل نشط أو على مستوى الموارد، فإن استخدام المورد المعتمد حسب العادة يمكن أن يؤدي إلى حدوث ارتباك. تستخدم العديد من الجداول الزمنية المهمة التابعة كإعداد افتراضي لأن تقويم النشاط هو أساس الجدولة الرئيسي.

استخدم المورد المعتمد عندما يكون المقصود من الموارد والتقويمات الخاصة بها التأثير على حساب الجدول.
...
كن حذرا مع منطق LOE. إذا تم ربط LOE بشكل غير صحيح، فقد يبدو أنه يؤدي إلى تغيير التواريخ أو تشويه التعويم. يجب مراجعة أنشطة LOE أثناء فحوصات جودة الجدول الزمني، خاصة عندما تظهر على المسار الحرج أو عندما تكون لها علاقات FS أو SF غير عادية.
...
- إذا كان توفر الموارد هو الذي يدفعها، فاستخدم "الاعتماد على المورد".
- إذا كان حدث بداية، فاستخدم Start Milestone.
...
الخطأ الثالث هو استخدام المورد المعتمد دون عملية جدولة تعتمد على الموارد. إذا لم تتم صيانة تقاويم الموارد، فقد يؤدي نوع النشاط إلى حدوث ارتباك أكثر من القيمة.
...
تمثل الأنشطة التابعة للمهمة معظم الأعمال العادية. تكون الأنشطة المعتمدة على المورد مفيدة عندما يجب أن تتحكم تقويمات الموارد في الجدولة. تحدد معالم البداية والنهاية النقاط الرئيسية في الوقت المناسب. تمثل أنشطة مستوى الجهد الدعم الذي يمتد إلى أعمال أخرى. تدعم أنشطة ملخص WBS إعداد التقارير المجمعة.
