...
في Primavera P6، تشير الأهمية عادةً إلى ما إذا كان النشاط يمكن أن يؤثر على تاريخ انتهاء المشروع إذا تأخر. تقليديًا، يحدد P6 الأنشطة المهمة باستخدام إعدادات التعويم الإجمالي أو المسار الأطول.

التعريف الحتمي المشترك بسيط:

- الأنشطة الحرجة هي الأنشطة ذات التعويم الصفري أو السلبي.
...
البعد الأول هو حساسية الجدول الزمني أو الاحتمالية. يمكن قياس ذلك من خلال عدد المرات التي يصبح فيها النشاط حرجًا أثناء محاكاة مونت كارلو، أو من خلال مدى قربه من المستوى الحرج بناءً على إجمالي التعويم أو العتبات القريبة من الحرجة.
...
تتضمن مقاييس المخاطر المهمة مؤشر الأهمية، وإجمالي التعويم، ومؤشر حساسية الجدول الزمني، والمدة أو قيمة التأثير.
...
يُظهر إجمالي التعويم مدى قرب النشاط من التأثير على إنهاء المشروع في الجدول الزمني المحدد. التعويم بالقرب من الصفر هو علامة تحذير.
...
قد لا يكون النشاط (ب) عاجلاً مثل النشاط (أ)، لكنه لا يزال يستحق الاهتمام. لديها تعويم محدود واحتمال كبير أن تصبح حرجة.

يحتوي النشاط C على نسبة تعويم أكبر وأهمية أقل. ولا ينبغي تجاهله، ولكنه لا يتطلب نفس المستوى من التركيز الإداري.
...
ابدأ بتصدير بيانات النشاط من P6. قم بتضمين معرف النشاط، واسم النشاط، وWBS، وإجمالي التعويم، والمدة المتبقية، والبدء، والانتهاء، والتقويم، والقيود، ومؤشرات المسار الحرج أو الأطول.

ثم قم بإضافة حقول تحليل المخاطر الاختيارية، مثل مؤشر الأهمية ومؤشر حساسية الجدول. إذا لم تكن بيانات المحاكاة متوفرة، استخدم الحدود العملية بناءً على التعويم والمدة. على سبيل المثال، قد تعني الأهمية العالية إجمالي التعويم أقل من أو يساوي 0 يومًا، أو CI أعلى من 70%. قد تعني الحرجية المتوسطة التعويم شبه الحرج أو CI بين 40% و70%.
...
تقوم مصفوفة الأهمية بتصنيف أنشطة المشروع حسب مدى احتمال أن تصبح حرجة ومدى التأثير الذي ستحدثه إذا تأخرت. ويستخدم بيانات P6 مثل إجمالي التعويم والمدة والقيود والمنطق، ويمكن تعزيزه بنتائج مونت كارلو مثل مؤشر الأهمية ومؤشر حساسية الجدول.
