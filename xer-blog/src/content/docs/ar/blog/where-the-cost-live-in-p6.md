...
تعد P6 في المقام الأول أداة جدولة، ولكنها يمكنها أيضًا دعم الجداول الزمنية المحملة بالتكلفة والقيمة المكتسبة والتدفق النقدي وإعداد التقارير المتوقعة. للقيام بذلك بشكل صحيح، يجب وضع التكلفة في الجزء الصحيح من نموذج الجدول الزمني.
...
تأتي تكاليف الموارد من الموارد المخصصة للأنشطة. قد يمثل المورد العمالة أو المعدات أو فئة موارد أخرى. يمكن أن يحتوي كل مورد على الأسعار والوحدات وحسابات التكلفة.
...
يمكن أن تدعم تكاليف الدور التخطيط المبكر عندما يعرف الفريق نوع المورد المطلوب ولكن ليس الشخص أو الطاقم المحدد.
...
إذا كانت التكلفة المدرجة في الموازنة مفقودة أو غير متسقة، فقد يستمر الجدول في حساب التواريخ، لكنه لا يمكنه دعم التقارير المحملة بالتكلفة ذات المغزى.
...
التكلفة الأساسية مهمة لتقارير التباين. بدون خط الأساس، قد يعرف المشروع تكلفة التنبؤ الحالية ولكن ليس ما إذا كان هذا التنبؤ أفضل أو أسوأ من الخطة المعتمدة.
...
تستخدم القيمة المكتسبة معلومات الجدول المحملة بالتكلفة لمقارنة العمل المخطط والعمل المكتسب والتكلفة الفعلية.

تكون هذه الحقول مفيدة عندما يكون للمشروع عملية رسمية للقيمة المكتسبة. وهي تتطلب خطوط أساس متسقة، وقواعد التقدم، وطرق نسبة الاكتمال، وتحميل التكلفة.
