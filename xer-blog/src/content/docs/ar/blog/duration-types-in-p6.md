...
يتم التخطيط للنشاط لمدة 10 أيام بـ 400 ساعة عمل. يريد فريق الجدول أن تظل المدة 10 أيام وأن يظل إجمالي الجهد المدرج في الموازنة 400 ساعة. إذا تغيرت تفاصيل تعيين المورد، فيجب ألا يتم نقل المدة المخططة وإجمالي الوحدات تلقائيًا.
...
يكون هذا النوع مفيدًا عندما يجب أن يحدث النشاط خلال فترة زمنية محددة ويجب أن يظل معدل تحميل المورد ثابتًا.
...
يكون هذا النوع مفيدًا عندما يعمل الطاقم أو المورد بمعدل ثابت طوال مدة استمرار النشاط.
...
- يتم تعيين المورد لمدة النشاط الكاملة.
...
هناك خطأ آخر يتمثل في استخدام سلوك المدة المستند إلى الموارد عندما لا يحتفظ المشروع بتعيينات الموارد بعناية. إذا كانت بيانات المورد ضعيفة، فقد تؤدي الحسابات المستندة إلى الموارد إلى نتائج غير موثوقة.

الخطأ الثالث هو تغيير الفترات أثناء التحديثات دون فهم كيفية قيام P6 بإعادة حساب الوحدات أو المعدلات. يمكن أن يؤثر ذلك على تحميل التكلفة، والقيمة المكتسبة، والمخططات التكرارية للموارد.
